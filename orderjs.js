              ...
              .then(function (data) {
                ...
                products.forEach(function (product) {
                  ...
                  li.innerHTML =
                    ...
                    "</div>" +
                    '<div class="total mt-1 text-dark"><span class="total-price"></span></div>' +
                    "</div>" +
                  ...
                  const quantityElement = li.querySelector(".quantity-number");
                  ...
                  orderButton.addEventListener("click", function () {
                    ...
                    function updateTotalSum() {
                      ...
                      if (totalSumElement) {
                        ...
                        const newTotalSumElement = document.createElement("p");
                        newTotalSumElement.id = "totalSum";
                        newTotalSumElement.textContent = "Total: ₱" + totalSum;
                        document
              ...
              .then(function (data) {
                ...
                products.forEach(function (product) {
                  ...
                  orderButton.addEventListener("click", function () {
                    ...
                    const ordersContainer = document.getElementById("orders3");
              ...
              .then(function (data) {
                ...
                products.forEach(function (product) {
                  ...
                  orderButton.addEventListener("click", function () {
                    ...
                    const ordersContainer = document.getElementById("orders5");
